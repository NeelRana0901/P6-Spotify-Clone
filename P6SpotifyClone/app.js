...
const songs = [
    ...
    },
    {
        id: 3,
        songName: `On & On <br>
        <div class="subtitle">Danial Levi</div>`,
        poster: "img/3.jpg"
    },
    {
        id: 4,
    ...
    },
    {
        ...
        <div class="subtitle">Asif Aslam</div>`,
        poster: "img/13.jpg"
    },
    {
        id: 14,
        songName: `Vaaste <br>
        <div class="subtitle">Dhvni Bhanushali</div>`,
        poster: "img/14.jpg"
    },
    {
        id: 15,
...
let currnetStart = document.getElementById('currnetStart');
let currnetEnd = document.getElementById('currnetEnd');
...
music.addEventListener('timeupdate', () => {
    ...
    currnetEnd.innerText = `${min1}: ${sec1}`;
    ...
    currnetStart.innerText = `${min2}: ${sec2}`;
